...
describe("removeAt", function () {
  ...
  it("removes node and adjusts nearby nodes", () => {
    let lst1 = new LinkedList([5, 10, 15, 20])
    lst1.removeAt(2)
    expect(lst1.length).toBe(3);
    expect(lst1.head.val).toBe(5);
    expect(lst1.head.next.val).toBe(10);
    expect(lst1.head.next.next.val).toBe(20);
  })
});
